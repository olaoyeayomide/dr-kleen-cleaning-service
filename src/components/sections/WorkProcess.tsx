    ...
    <section className="bg-center h-fit py-16 overflow-hidden">
      <div className="container mx-auto max-w-screen-lg px-4 items-center">
        <div className="text-center mb-10">
          <h2 className="font-public text-primary text-xs md:text-sm tracking-widest">
            OUR WORKING PROCESS
          </h2>
          <p className="font-bree text-secondary mb-4 text-3xl sm:text-2xl md:text-4xl lg:text-4xl font-bold tracking-tight leading-none">
            WORK PROCESS
          </p>
        </div>
