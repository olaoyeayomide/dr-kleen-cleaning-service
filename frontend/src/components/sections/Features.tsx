...
const Features: React.FC = () => {
  return (
    <section className="container max-w-screen-lg mx-auto px-4 items-center relative">
      <div className="flex-wrap w-full md:flex-nowrap justify-between gap-10 items-center p-4 flex justify-self-center py-4 -mt-4 bg-white border border-gray-200 rounded-lg shadow-lg shadow-blue-500/50">
        <div className="px-4">
